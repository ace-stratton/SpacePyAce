# -*- coding: utf-8 -*-
"""
Created on Wed Dec  4 11:26:56 2024

@author: Ace Stratton

This will run all the GNSS Testing. Should take about 2 minutes
"""
import os
import pytest
...
def main():
    ...
    test_dir = os.path.join(project_dir, 'GNSSTest')
    ...
    report_file = os.path.join(report_dir, f'GNSSreport_{now}.html')
