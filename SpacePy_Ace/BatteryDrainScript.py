...
while ConOpsMode == 4:
	...
	upTime = TimeOut['s__upTime']
	timeSeconds = upTime.uint8__seconds + (upTime.uint8__minutes * 60) + (upTime.uint8__hours*3600)
...
fileName = 'BatteryDrainCurve_IdleMode_NoSPInput.csv'
...
ax1.set_title('Battery Drain Curve Idle Mode')
...
fig.tight_layout()
plt.show()
fig.savefig('BatteryDrainCurve_IdleMode_NoSPInput.png', dpi=300)
