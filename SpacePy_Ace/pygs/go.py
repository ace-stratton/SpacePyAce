...
# python wrapper for package go within overall package pygs
...
# Python type for *yaml.Node
class Ptr_yaml_Node(GoClass):
	""""""
	def __init__(self, *args, **kwargs):
		"""
		handle=A Go-side object is always initialized with an explicit handle=arg
...
# Python type for util.ConfigUnmarshaler
class util_ConfigUnmarshaler(GoClass):
	""""""
	def __init__(self, *args, **kwargs):
		"""
		handle=A Go-side object is always initialized with an explicit handle=arg
...
# Python type for util.Observer
class util_Observer(GoClass):
	""""""
	def __init__(self, *args, **kwargs):
		"""
		handle=A Go-side object is always initialized with an explicit handle=arg
...
# Python type for yaml_config.Option
class yaml_config_Option(GoClass):
	""""""
	def __init__(self, *args, **kwargs):
		"""
		handle=A Go-side object is always initialized with an explicit handle=arg
